...
## Download
#### Windows
Click [spock_win64_v1.2.6.exe](https://raw.githubusercontent.com/spockchain/spock/master/spock_win64_v1.2.6.exe "spock_win64_v1.2.6.exe") to download.

#### Linux
```shell
$ wget https://raw.githubusercontent.com/spockchain/spock/master/spock_linux_amd64_v1.2.6
$ chmod +x spock_linux_amd64_v1.2.6
$ ./spock_linux_amd64_v1.2.6 --version
```
...
#### Windows
```shell
> spock_win64_v1.2.6.exe console
```

#### Linux
```shell
$ ./spock_linux_amd64_v1.2.6 console
```
This command will:
