...
## Download
#### Windows
Click [spock_win64_v1.2.4.exe](https://raw.githubusercontent.com/spockchain/spock/master/spock_win64_v1.2.4.exe "spock_win64_v1.2.4.exe") to download.

#### Linux
```shell
$ wget https://raw.githubusercontent.com/spockchain/spock/master/spock_linux_amd64_v1.2.4
$ chmod +x spock_linux_amd64_v1.2.4
$ ./spock_linux_amd64_v1.2.4 --version
```
...
#### Windows
```shell
> spock_win64_v1.2.4.exe console
```

#### Linux
```shell
$ ./spock_linux_amd64_v1.2.4 console
```
This command will:
