...
## Download
#### Windows
Click [spock_win64_v1.2.5.exe](https://raw.githubusercontent.com/spockchain/spock/master/spock_win64_v1.2.5.exe "spock_win64_v1.2.5.exe") to download.

#### Linux
```shell
$ wget https://raw.githubusercontent.com/spockchain/spock/master/spock_linux_amd64_v1.2.5
$ chmod +x spock_linux_amd64_v1.2.5
$ ./spock_linux_amd64_v1.2.5 --version
```
...
#### Windows
```shell
> spock_win64_v1.2.5.exe console
```

#### Linux
```shell
$ ./spock_linux_amd64_v1.2.5 console
```
This command will:
