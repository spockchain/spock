...
## Download
#### Windows
Click [spock_win64_v2.2.3.exe](https://raw.githubusercontent.com/spockchain/spock/master/spock_win64_v2.2.3.exe "spock_win64_v2.2.3.exe") to download.

#### Linux
```shell
$ wget https://raw.githubusercontent.com/spockchain/spock/master/spock_linux_amd64_v2.2.3
$ chmod +x spock_linux_amd64_v2.2.3
$ ./spock_linux_amd64_v2.2.3 --version
```
...
#### Windows
```shell
> spock_win64_v2.2.3.exe console
```

#### Linux
```shell
$ ./spock_linux_amd64_v2.2.3 console
```
This command will:
